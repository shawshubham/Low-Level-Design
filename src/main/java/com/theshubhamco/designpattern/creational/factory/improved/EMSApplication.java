package com.theshubhamco.designpattern.creational.factory.improved;

import com.theshubhamco.designpattern.creational.factory.improved.formatter.EmployeeFormatter;
import com.theshubhamco.designpattern.creational.factory.improved.model.*;
import com.theshubhamco.designpattern.creational.factory.improved.persistence.EmployeePersistenceFactory;
import com.theshubhamco.designpattern.creational.factory.improved.persistence.EmployeePersistenceStrategy;
import com.theshubhamco.designpattern.creational.factory.improved.persistence.PersistenceType;
import com.theshubhamco.designpattern.creational.factory.improved.salary.SalaryCalculator;
import com.theshubhamco.designpattern.creational.factory.improved.service.EmployeeService;
...
public class EMSApplication {
    ...
    public static void main(String args[]) {
        ...
        EmployeePersistenceStrategy persistenceStrategy =
                EmployeePersistenceFactory.create(PersistenceType.FILE);
